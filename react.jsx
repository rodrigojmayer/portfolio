    ...
    let num_array = new Array, project = "", projects = "", folder = "", images = new Array, title = "", client = "", description_eng = "", description_esp = "", link = ""
        ...
        if (modal.id == "project-5") {
            ...
            images = [
                ...
                { src: '12-Export-transaction',     h4_eng: 'Export transaction',           h5_eng: 'Transaction exported to Googhe sheet history, split by customer.',                                     h4_esp: 'Exportar transacción',         h5_esp: 'Transacción exportada al historial de Google Sheets, separado por cliente.' },
            ]
