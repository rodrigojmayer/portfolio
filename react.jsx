...
function Modal(){
    let num_array = new Array, project = "", projects = "", folder = "", images = new Array, title = "", client = "", description_eng = "", description_esp = "", link = ""
        ...
        if (modal.id == "project-11") {
            ...
            folder = "StockPro"
            images = [
                { src: '00-Main-page',              h4_eng: 'Main page unlogged',                           h5_eng: 'Home page before registration. Options to select a language, log in by user or gmail, ask if you forgot your password, or sign up a new user.',    h4_esp: 'Página principal sin inicio de sesión',            h5_esp: 'Página de inicio antes del registro. Opciones para seleccionar un idioma, iniciar sesión con usuario o Gmail, preguntar si olvidó su contraseña o registrar un nuevo usuario.' },
                { src: '01-Sign-up',                h4_eng: 'Sign up',                                      h5_eng: 'Allows you to create a new user.',                                                                                                                 h4_esp: 'Página de registro',                               h5_esp: 'Permite crear un nuevo usuario.' },
                { src: '02-Log-in-with-user-pass',  h4_eng: 'Log in with user and password',                h5_eng: 'It allows users to login with predefined user and password.',                                                                                      h4_esp: 'Iniciar sesión con usuario y pasword',             h5_esp: 'Permite a los usuarios iniciar sesión con un usuario y contraseña predefinidos.' },
                { src: '03-Log-in-with-gmail',      h4_eng: 'Automatic registration and login with Gmail',  h5_eng: 'Allows you to automatically create your user with your Gmail account, and log in with it.',                                                        h4_esp: 'Registro automatico e inicio de sesión con Gmail', h5_esp: 'Permite crear usuario automaticamente con su cuenta de Gmail, e iniciar sesión con la misma.' },
